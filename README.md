...
```
    ...
    """This environment has two locations, A and B. Each can be unhealthy or healthy. The agent perceives its location and the location's status. This serves as an example of how to implement a simple 
    Environment."""
...
![image](https://github.com/user-attachments/assets/adec80b9-6a65-4b39-8f74-33936eccfca3)
